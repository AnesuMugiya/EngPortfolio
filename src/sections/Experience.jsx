...
const Experience = () => {
  ...
  return (
    <section id="experience" className="flex-center md:mt-40 mt-20 pb-20 section-padding xl:px-0 overflow-hidden">
        ...
        <div className="mt-32 grid md:grid-cols-2 gap-16">
          ...
          <div className="timeline-column relative">
            ...
            <div className="absolute left-[5px] top-[70px] w-px h-full overflow-hidden">
              ...
              <span className="timeline absolute top-0 left-0 w-full h-full bg-gradient-to-b from-amber-400 via-yellow-300 to-white/5" />
            </div>
              ...
              {expCards.map((card, index) => (
                <div key={card.title} className="timeline-card flex items-start gap-6">
                  ...
                  <div className="expText">
                    ...
                    <p className="text-[#f4c331] italic mt-3">Responsibilities</p>
