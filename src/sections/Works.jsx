...
const Works = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      "description": "Developed a real-time honey badger monitoring system using ESP32-CAM devices, cloud-based AI detection, and a Django backend with MQTT communication.",
    ...
    },
    {
      ...
      "tags": ["Machine Learning", "Deep Learning", "Python", "PyTorch", "scikit-learn", "Time Series"],
    ...
    },
    {
      ...
      "tags": ["Django", "Bootstrap", "jQuery", "AJAX", "Web Development", "Learning Platform", "Forum", "Tutorials"],
      "category": "Software",
